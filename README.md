...
PC details
This single page presents mini information on PCs
This site is composed of the following elements
Html
css
javascript 
et un db.json
for the java script we use the following elements fetch and a for each
# Projet
